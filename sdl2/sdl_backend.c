...
static SDL_Color colors[] = {
    ...
    { 0xdd, 0xdd, 0x00, 0xff },     // COLOR_YELLOW
    { 0x22, 0x33, 0x44, 0xff },     // COLOR_BACKGROUND
    { 0x11, 0x22, 0x33, 0xff },     // COLOR_BACKGROUND_SHADOW
    { 0xcc, 0xcc, 0xcc, 0xff },     // COLOR_WINDOW_BACKGROUND
    { 0x11, 0x88, 0xaa, 0xff },     // COLOR_SELECTION_BAR
    { 0x11, 0x11, 0x11, 0xff },     // COLOR_ITEM_TEXT
    { 0xee, 0xee, 0xee, 0xff },     // COLOR_ITEM_HIGHLIGHT_TEXT
    { 0xaa, 0xaa, 0xaa, 0xff },     // COLOR_DIALOG_BACKGROUND
    { 0x99, 0x88, 0x00, 0xff },     // COLOR_DARK_YELLOW
    { 0xee, 0x22, 0x22, 0xff },     // COLOR_RED
    { 0x88, 0x00, 0x00, 0xff },     // COLOR_DARK_RED
    { 0x66, 0xcc, 0x00, 0xff },     // COLOR_GREEN
    { 0x11, 0x55, 0x00, 0xff },     // COLOR_DARK_GREEN
};
