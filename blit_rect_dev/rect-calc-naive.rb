...
def blit_rects(x, w)
  ...
  if x_end_bound == 3
    ...
    main_rect_x_end = x_end / 4 * 4 + 3
  else
    main_rect_x_end = x_end / 4 * 4 - 1
  end
  ...
  if left_rect_w == 0
    ...
    left_blit_start = left_rect_x / 4
    left_blit_words = left_rect_w / 4
  ...
  if main_rect_w == 0
    ...
    main_blit_start = main_rect_x / 4
    main_blit_words = main_rect_w / 4
  ...
  if right_rect_w == 0
    ...
    right_blit_start = right_rect_x / 4
    right_blit_words = right_rect_w / 4
